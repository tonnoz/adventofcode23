...
object Day11Part2 {
  ...
  fun part2(input: ArrayList<CharArray>) {
  ...
  data class GalaxyPair(val a: Galaxy, val b: Galaxy, val distance: Long = 0L)
  ...
  private fun Boolean.toLong() = if(this) 999999L else 0L
